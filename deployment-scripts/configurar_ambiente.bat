...
echo # Servidor SQL Server con vista sonacard >> "%ENV_FILE%"
echo DB_SERVER=10.7.74.80 >> "%ENV_FILE%"
echo DB_NAME=empresadb >> "%ENV_FILE%"
echo DB_USERNAME=sonacarduser >> "%ENV_FILE%"
echo DB_PASSWORD=Angola2025 >> "%ENV_FILE%"
echo. >> "%ENV_FILE%"
...
echo # RATE LIMITING (SOLO MEMORIA - SIN REDIS) >> "%ENV_FILE%"
echo RATELIMIT_STORAGE_URL=memory:// >> "%ENV_FILE%"
echo. >> "%ENV_FILE%"
